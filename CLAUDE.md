...
**YOU ARE IN: `pmgetrich/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/pmgetrich/` (rig root) or other directories
...
**Your mail address:** `pmgetrich/polecats/furiosa`
**Your rig:** pmgetrich
**Your Witness:** `pmgetrich/witness`
...
| Ask Witness for help | `gt mail send pmgetrich/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`pmgetrich/witness`) when:
...
```bash
gt mail send pmgetrich/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
